...
export class JobsTodayComponent implements AfterViewInit {
  ...
  constructor(
    ...
    private readonly _router: Router) {
      this.dataTable = {
        headerRow: ['ที่', 'วันที่รับเรื่อง', 'เวลา', 'เลขที่รับเรื่อง', 'เลขหมาย', 'สถานที่', 'ความต้องการ/อาการเสีย', 'เคเบิ้ล', 'หมายเลขติดต่อกลับ', 'สถานะ' ],
        footerRow: ['ที่', 'วันที่รับเรื่อง', 'เวลา', 'เลขที่รับเรื่อง', 'เลขหมาย', 'สถานที่', 'ความต้องการ/อาการเสีย', 'เคเบิ้ล', 'หมายเลขติดต่อกลับ', 'สถานะ' ],
        dataRows: [],
      };
  ...
  initTable() {
    ...
    let table = $('#jobs-today-table').DataTable({
      ...
      columnDefs: [
        ...
        { targets: [-1,-3], width: '6rem', className: 'text-center' },
        { targets: [-2], width: '10rem', className: 'text-center' },
      ],
      responsive: true,
      language: {
        search: "_INPUT_",
