...
declare let $:any;
@Component({
  selector: 'app-jobs-closed-tech',
  standalone: true,
  imports: [ CommonModule,FormsModule],
  templateUrl: './jobs-closed-tech.component.html',
  styleUrl: './jobs-closed-tech.component.css'
})
export class JobsClosedTechComponent {
  ...
  constructor(
    ...
    this.dataTable = {
      headerRow: ['ที่', 'วันที่รับเรื่อง', 'เวลา', 'เลขที่รับเรื่อง', 'สายโทรเข้า', 'สถานที่', 'ความต้องการ/สอบถาม', 'หมายเลขติดต่อ', 'สถานที่/แผนก' ],
      footerRow: ['ที่', 'วันที่รับเรื่อง', 'เวลา', 'เลขที่รับเรื่อง', 'สายโทรเข้า', 'สถานที่', 'ความต้องการ/สอบถาม', 'หมายเลขติดต่อ', 'สถานที่/แผนก' ],
      dataRows: [],
    };
  ...
  initTable() {
    ...
    let table = $('#jobs-completed-table').DataTable({
      ...
      columnDefs: [
        ...
        { targets: [1,2,3,4,-2], width: '8rem', className: 'text-center' },
      ],
      responsive: true,
      language: {
        search: "_INPUT_",
